...
import {
    ...
    FaPills, FaHospital, FaClock, FaSun, FaMoon, FaCloudSun,
    FaHeartbeat,
} from 'react-icons/fa';
...
const CreatePrescriptionPage = () => {
    ...
    const handleSubmit = async () => {
        ...
        setSaving(true);
        try {
            const fd = new FormData(); // ← був відсутній цей рядок
                ...
                <div className={styles.formSection}>
                    ...
                    {files.length > 0 && (
                        <div className={styles.fileList}>
                            {files.map((f, i) => <FileItem key={i} file={f} index={i} onRemove={handleFileRemove} onTypeChange={handleFileType} />)}
                        </div>
                    )}
                </div>
