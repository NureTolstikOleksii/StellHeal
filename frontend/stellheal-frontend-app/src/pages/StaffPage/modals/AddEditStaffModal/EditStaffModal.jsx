...
const FormInput = ({ name, label, placeholder, type = 'text', value, onChange, error, styles }) => (
...
const EditStaffModal = ({ onClose, onSave, staffData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setServerError(err?.response?.data?.message || err?.response?.data?.error || t('staff.update_error'));
        } finally {
            setSaving(false);
        }
    };
            ...
            <div className={styles.modal} onClick={e => e.stopPropagation()}>
                ...
                <div className={styles.modalHeader}>
                    <div className={styles.modalTitleRow}>
                        ...
                        <h3 className={styles.title}>{t('staff.edit_title')}</h3>
                    </div>
                    ...
                    <div className={styles.row}>
                        <div className={styles.fieldGroup}>
                            ...
                            <MuiDatePicker
                                ...
                                onChange={date => {
                                    setFormData(p => ({ ...p, date_of_birth: date }));
                                    setErrors(p => { const u = { ...p }; delete u.date_of_birth; return u; });
                                }}
